    ...
    switch (taleIdStr) {
       case '1':
        ...
        case '2':
            content = (
                <>
                    <h1 className="fairy-tale-title">Линялый Фосфор</h1>
                    <p className="fairy-tale-text">
                        ...
                        <span className="fairy-tale-quote">«Это невероятно!»</span>
                        ...
                        <img src="https://example.com/image.jpg" alt="Заброшенный дом"
                             className="fairy-tale-illustration"/>
                        ...
                        <span className="fairy-tale-ending">Так Линай открыл новый мир науки и исследований, благодаря своей любознательности и стремлению к знаниям.</span>
        ...
        case '3':
            content = (
                <>
                    <h1 className="fairy-tale-title">Прокашивать Монументальный</h1>
                    <p className="fairy-tale-text">
                        ...
                        Каждый
                        день она наблюдала за тем, как отец создает величественные мечи и доспехи для рыцарей
                        королевства.
                        ...
                        сохранить
                        его как сувенир. Вернувшись домой, она положила мраморный осколок на полку в своей комнате.

                        Прошло несколько дней, и Алина заметила, что мраморный осколок начал менять цвет. Сначала он
                        стал
                        золотым, потом красным, а затем зеленым. Девушка была поражена этим явлением и решила спросить
                    совета у отца.
                    ...
                    <span className="fairy-tale-ending">Так Алина стала известной скульптором, и её работы украшают многие города и дворцы. А мраморный осколок, который она нашла, до сих пор хранится у неё как напоминание о том, что даже самые маленькие вещи могут обладать великой силой.</span>
